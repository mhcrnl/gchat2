...
PrefsEntry vars[] = {
	...
	{"gui_tweak_usercount", PREFS_TYPE_BOOL, &prefs.gui_tweak_usercount},
	{"gui_tweak_hidebutton", PREFS_TYPE_BOOL, &prefs.gui_tweak_hidebutton},
	{"gui_tweak_swappanes", PREFS_TYPE_BOOL, &prefs.gui_tweak_swappanes},
	{"gui_tweak_nolines", PREFS_TYPE_BOOL, &prefs.gui_tweak_nolines},
	{"gui_tweak_showkey", PREFS_TYPE_BOOL, &prefs.gui_tweak_showkey},
	{"gui_tweak_smallrows", PREFS_TYPE_BOOL, &prefs.gui_tweak_smallrows},
	{"gui_tweak_useprefixes", PREFS_TYPE_BOOL, &prefs.gui_tweak_useprefixes},
	{"gui_tweak_noattribute", PREFS_TYPE_BOOL, &prefs.gui_tweak_noattribute},
	{"gui_tweak_ellipse", PREFS_TYPE_BOOL, &prefs.gui_tweak_ellipse},
